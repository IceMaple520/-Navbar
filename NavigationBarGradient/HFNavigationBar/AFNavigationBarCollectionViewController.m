//
//  AFNavigationBarCollectionViewController.m
...
#import "AFNavigationBarCollectionViewController.h"

@interface AFNavigationBarCollectionViewController ()<UIGestureRecognizerDelegate>
...
@implementation AFNavigationBarCollectionViewController
...
{
    self.isCompatibilityMode = ([[[UIDevice currentDevice] systemVersion] compare:@"8.0" options:NSNumericSearch] == NSOrderedAscending);
